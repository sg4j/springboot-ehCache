...
import com.petclinic.repository.springdatajpa.mysql.SpringDataOwnerRepository;
...
public class OwnerServiceEndpoint {
	...
	public Collection<com.petclinic.entity.mysql.Owner> getOwnerByLastName(@RequestParam(value="name") String ownerName){
